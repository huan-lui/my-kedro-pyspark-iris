...
# my_kedro_pyspark_iris documentation build
...
from my_kedro_pyspark_iris import __version__ as release

# -- Project information -----------------------------------------------------

project = "my_kedro_pyspark_iris"
author = "Kedro"
...
htmlhelp_basename = "my_kedro_pyspark_irisdoc"
...
latex_documents = [
    (
        master_doc,
        "my_kedro_pyspark_iris.tex",
        "my_kedro_pyspark_iris Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "my_kedro_pyspark_iris",
        "Project my_kedro_pyspark_iris codebase.",
        "Nearest-Neighbour",
    )
]
